  ...
  const donationTiers = [
    {
      ...
      description: "Provides 4 care package with comfort items",
      impact: "4 patient receives care",
    },
    {
      amount: 50,
      icon: Heart,
      title: "Compassion Package",
      description: "Provides 10 care packages",
      impact: "10 patients receive support",
    },
    {
      amount: 100,
      icon: Users,
      title: "Community Care",
      description: "Provides 20 care packages",
      impact: "20 patients helped",
    },
    {
      amount: 250,
      icon: Sparkles,
      title: "Impact Supporter",
      description: "Provides 50 care packages",
